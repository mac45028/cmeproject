 ...
 * 
 * \param [in] param_parameter Interface Parameter array parameter[] should be of size 6.
 ...
 */
typedef struct { 
	const float *param_parameter; /**<  [in] Interface Parameter array parameter[] should be of size 6. */
