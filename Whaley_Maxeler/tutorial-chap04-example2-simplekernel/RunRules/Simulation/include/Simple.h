 ...
 * 
 * \param [in] param_parameter Interface Parameter array parameter[] should be of size 5.
 * \param [in] ticks_SimpleKernel The number of ticks for which kernel "SimpleKernel" will run.
 * \param [out] outstream_y The stream should be of size 32 bytes.
 */
void Simple(
	const float *param_parameter,
	uint64_t ticks_SimpleKernel,
	float *outstream_y);
 ...
 */
typedef struct { 
	const float *param_parameter; /**<  [in] Interface Parameter array parameter[] should be of size 5. */
	uint64_t ticks_SimpleKernel; /**<  [in] The number of ticks for which kernel "SimpleKernel" will run. */
	float *outstream_y; /**<  [out] The stream should be of size 32 bytes. */
} Simple_actions_t;
