...
// two types of boards
enum EnumBoardType {btMax2, btMax3, btMax4SixDimm, btMax4ThreeDimm};
/* burst sizes:
    Max2       :         96 bytes;
...
public:
	...
	static MemoryControllerConfigPtr getMax4SixDimmConfig(int number_words_per_burst, uint32_t eccParityEngineBitSize, uint32_t checkLevel, uint32_t max2CompatMode, uint32_t quarterMode, uint32_t cmdQSize);
	static MemoryControllerConfigPtr getMax4ThreeDimmConfig(int number_words_per_burst, uint32_t eccParityEngineBitSize, uint32_t checkLevel, uint32_t max2CompatMode, uint32_t quarterMode, uint32_t cmdQSize);
